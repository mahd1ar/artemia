...
const items = reactive([
    {
        text: '  Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempora eius iusto placeat numquam incidunt nesciunt vitae inventore impedit amet. Architecto porro dolorem possimus tenetur in, adipisci excepturi et quaerat cum.',
        autor: 'LOLA BARLY',
        image: 'https://templatekit.jegtheme.com/findive/wp-content/uploads/sites/185/2021/10/happy-friends-men-enjoying-summer-vacation-and-scu-EUX8KUF.jpg',
    },
    {
        text: '  Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempora eius iusto placeat numquam incidunt nesciunt vitae inventore impedit amet. Architecto porro dolorem possimus tenetur in, adipisci excepturi et quaerat cum.',
        autor: 'MAHDIYAR ANARI',
        image: 'https://templatekit.jegtheme.com/findive/wp-content/uploads/sites/185/2021/10/happy-friends-men-enjoying-summer-vacation-and-scu-EUX8KUF.jpg',
    },
]);
</script>
...
<template>
    <section class="relative flex flec-col">
        <div class="overlay">
            <img
                ...
                >
                    ...
                    >
                        ...
                        <div class="overflow-hidden mt-4 flex">
                            ...
                            />
                            <div class="px-4">
                                <p class="text-lg">{{ i.autor }}</p>
                                <strong class="text-primary text-sm uppercase"
                                    >manager</strong
                                >
                            </div>
                        </div>
